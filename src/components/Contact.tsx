...
export default function Contact() {
  ...
  const links = [
    { label: 'Email Me',  href: 'mailto:kelseynocekugc@gmail.com', primary: true  },
    { label: 'TikTok ↗', href: 'https://tiktok.com/@YOUR_HANDLE',  primary: false },
    { label: 'Instagram ↗', href: 'https://instagram.com/YOUR_HANDLE', primary: false },
  ];
